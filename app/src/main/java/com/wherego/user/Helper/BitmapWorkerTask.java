package com.wherego.user.Helper;
...
public class BitmapWorkerTask extends AsyncTask<Uri, Void, Bitmap> {
    ...
    public static final String ADD_REVENUE = "imageOne";
//    public static final String ADD_REVENUE_ = "imageOne_";
//    public static final String ADD_REVENUE__ = "imageOne__";
//    public static final String ADD_REVENUE___ = "imageOne___";
//    public static final String ADD_REVENUE____ = "imageOne____";
...
//                    completion = (UplaodImage) context;
...
//                if (callerString.equals(ADD_REVENUE_)) {
//                    completion = (UplaodImage) context;
//                    completion.onBitmapScaleComplete(bitmap);
//                }
//                if (callerString.equals(ADD_REVENUE__)) {
//                    completion = (UplaodImage) context;
//                    completion.onBitmapScaleComplete(bitmap);
//                }
//                if (callerString.equals(ADD_REVENUE___)) {
//                    completion = (UplaodImage) context;
//                    completion.onBitmapScaleComplete(bitmap);
//                }
//                if (callerString.equals(ADD_REVENUE____)) {
//                    completion = (UplaodImage) context;
//                    completion.onBitmapScaleComplete(bitmap);
//                }
