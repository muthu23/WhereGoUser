...
public class MyCourier extends Application {

    public static final String TAG = MyCourier.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static MyCourier mInstance;
    ...
    public static synchronized MyCourier getInstance() {
        return mInstance;
    }
