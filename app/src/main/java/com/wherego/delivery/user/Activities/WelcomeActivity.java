...
import com.wherego.delivery.user.Utils.PrefManager;
...
//            dotsLayout.addView(dots[i]);
    ...
    private void launchHomeScreen() {
        ...
        if (SharedHelper.getKey(WelcomeActivity.this, "loggedIn").equalsIgnoreCase(getString(R.string.True))) {
            ...
            if (getIntent().getExtras() != null) {
                try{
                    ...
                    Log.v("Welcome", "msgType: " + msgType);
                    Log.v("Welcome", "msg: " + msg);
                    if (msgType.equalsIgnoreCase("chat")) {
                        Intent intent = new Intent(WelcomeActivity.this, UserChatActivity.class);
