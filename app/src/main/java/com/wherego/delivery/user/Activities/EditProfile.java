...
import com.wherego.delivery.user.Helper.AppHelper;
...
//        last_name =  findViewById(R.id.last_name);
        ...
        //Glide.with(activity).load(SharedHelper.getKey(context, "picture")).placeholder(R.drawable.loading).error(R.drawable.user).into(profile_Image);
    ...
    public void displayMessage(String toastString) {
        ...
        Snackbar.make(findViewById(R.id.tvLocationHome), toastString, Snackbar.LENGTH_SHORT)
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < locarray.length(); i++) {
                                        ...
                                        if (locationType.equals("Home")) {
                                            ...
                                            SharedHelper.putKey(EditProfile.this, "Homelatitude",lat);
                                            SharedHelper.putKey(EditProfile.this, "Homelongitude",lng);
                                            tvLocationHome.setText("Home");
                                        ...
                                        if (locationType.equals("Work")) {
                                            ...
                                            SharedHelper.putKey(EditProfile.this, "Worklatitude",lat);
                                            SharedHelper.putKey(EditProfile.this, "Worklongitude",lng);
                                            tvLocationWork.setText("Work");
